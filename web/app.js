...
// ------------------------------------------------------------------------------------------------
//
// Сім перемикачів, а не один. «Увімкнути ШІ» — це не рішення, яке оператор може ухвалити один раз:
// наратив аналітики бачить лише він сам, дайджест іде тисячам людей у Telegram, коментар до тактики
// лягає на публічну сторінку, а формулювання екстраполяції й дослідження області не залишають цієї
// консолі взагалі. Ціна помилки в кожному з цих місць різна, тож і вимикач у кожного свій. Під
// кожним підписано, куди саме потрапить текст, — бо це і є те, що визначає, наскільки страшно його
// вмикати.
