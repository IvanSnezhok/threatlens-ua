...
// Тест дзеркала обчислює цей літерал і порівнює його з THREAT_ICON_PATHS цілком — ключ за ключем, а
// не пошуком підрядка по тексту файлу: пошук пропустив би два path, переставлені між класами, і
// карта малювала б бомбу на місці дрона. Тож сам літерал мусить лишатися чистими даними — без
// виразів, що посилаються на щось поза ним.
//
// Власні малюнки на сітці 24×24 під правило evenodd: отвори (колесо гаубиці, труби РСЗВ, кільце
// знака питання) — це зустрічні підконтури, тож і канвас, і SVG легенди мусять заливати їх саме
// за evenodd, інакше отвори зафарбуються.
//
...
const threatIconPaths = {
  ballistic_missile: 'M17.6 2.2L18.01 3.93L17.87 5.64L15.84 9.99L16.69 14.8L15.42 14.2L14.49 12.89L11.41 11.45L9.8 11.58L8.53 10.99L12.76 8.55L14.79 4.2L16.01 3ZM13.83 13.35L11.01 16.34L11.48 12.25ZM3.6 21.6C4.4 17.4 6.4 15 9.4 14.4L9.8 15.8C7.3 16.4 6 18.3 5.3 21.8Z',
  guided_air_bomb: 'M8.4 2.2H15.6L13.3 5.4L15 7.8V9.2H22.6V11.1H15V17.2C15 20.2 13.4 22.2 12 23C10.6 22.2 9 20.2 9 17.2V11.1H1.4V9.2H9V7.8L10.7 5.4Z',
  cruise_missile: 'M23 12C21.8 11 20 10.8 17.8 10.8H14L10.6 7.8H9.2L11.8 10.8H6.8L3.6 8.2H2.4V15.8H3.6L6.8 13.2H11.8L9.2 16.2H10.6L14 13.2H17.8C20 13.2 21.8 13 23 12Z',
  uav: 'M12 1.9C12.8 1.9 13.2 3 13.2 4.2V6L20.4 13.6V12.4H21.8V18.6H20.4V17.2L13.2 18.2V19.4H10.8V18.2L3.6 17.2V18.6H2.2V12.4H3.6V13.6L10.8 6V4.2C10.8 3 11.2 1.9 12 1.9ZM8.6 20.2H15.4V21.4H8.6Z',
  aviation: 'M12 1.2L13.1 4.4V8.2L21.8 14V15.6L13.1 13.4V17.4L17.8 20.6V22L13.1 21.2L12.6 22.8H11.4L10.9 21.2L6.2 22V20.6L10.9 17.4V13.4L2.2 15.6V14L10.9 8.2V4.4Z',
  mlrs: 'M1.8 15H17.2V10.2H20.6L22.4 12.4V17.2H1.8ZM2.9 19.7A2.1 2.1 0 1 0 7.1 19.7A2.1 2.1 0 1 0 2.9 19.7ZM7.7 19.7A2.1 2.1 0 1 0 11.9 19.7A2.1 2.1 0 1 0 7.7 19.7ZM17.1 19.7A2.1 2.1 0 1 0 21.3 19.7A2.1 2.1 0 1 0 17.1 19.7ZM3 14.2L14.04 8.33L12.07 4.62L1.03 10.49ZM3.5 12.58L13.47 7.27L13.14 6.65L3.17 11.96ZM2.89 11.43L12.86 6.12L12.53 5.51L2.56 10.81ZM6 15V12.6L8 11.54V15Z',
  artillery: 'M5.23 11.66L13.03 7.56L13.29 8.05L19.47 4.76L19.28 4.41L20.52 3.75L21.6 5.78L20.36 6.44L20.17 6.09L13.99 9.37L14.25 9.86L7.51 13.39L4 20.2H2.4L2.7 19.4L5.98 13.07ZM6.3 17.3A4.4 4.4 0 1 0 15.1 17.3A4.4 4.4 0 1 0 6.3 17.3ZM7.8 17.3A2.9 2.9 0 1 0 13.6 17.3A2.9 2.9 0 1 0 7.8 17.3ZM9.45 17.3A1.25 1.25 0 1 0 11.95 17.3A1.25 1.25 0 1 0 9.45 17.3Z',
  mortar: 'M7.78 20.26L16.98 3.86L14.62 2.54L5.42 18.94ZM4.2 20.6H11.2V21.8H4.2ZM13.5 10.2L14.9 9.9L20 20.8H18.4L15.5 14.8L15.9 20.8H14.3Z',
  combined: 'M8.6 5.8L9.42 7.09V8.52L14.31 13.69V12.87H15.05V17.09H14.31V16.14L9.42 16.82V17.63H7.78V16.82L2.89 16.14V17.09H1.94V12.87H2.89V13.69L7.78 8.52V7.09ZM6.29 18.18H10.91V18.99H6.29ZM17.6 2.2L18.76 4L19.05 5.6V15.8L21.35 18.8V20L19.05 19.2V18.4H16.15V19.2L13.85 20V18.8L16.15 15.8V5.6L16.44 4Z',
  unknown: 'M.8 12A11.2 11.2 0 1 0 23.2 12A11.2 11.2 0 1 0 .8 12ZM2.8 12A9.2 9.2 0 1 0 21.2 12A9.2 9.2 0 1 0 2.8 12ZM7.3 9A4.7 4.7 0 1 1 15.6 12.02L13.4 13.4V15.4H10.6V12.8L13.46 10.22A1.9 1.9 0 1 0 10.1 9ZM10.45 18.3A1.55 1.55 0 1 0 13.55 18.3A1.55 1.55 0 1 0 10.45 18.3Z'
};
...
const ICON_CHIP_PX = 24;        // CSS px — фінальний розмір фішки на карті
const ICON_PIXEL_RATIO = 2;     // бітмап 48×48, як у occupation-hatch-pattern
// Гліф займає 80% фішки, а не 60%: при 60% тонкі елементи — шайби «Шахеда», станина гаубиці, прорізи
// труб РСЗВ — на оглядовому масштабі зникали повністю. Гліфи намальовано так, щоб усе суттєве лежало
// в колі радіусом ~12 одиниць сітки: фішка кругла, і кут квадрата вона обрізала б власним обводом.
const ICON_GLYPH_BOX = 19;      // CSS px — у цей квадрат вписується гліф
...
// Крок 27 px проти фішки 24 px лишає 3 px проміжку — рівно стільки, щоб власний темний обвід
// фішки читався як роздільник на будь-якому масштабі. Крок звузився разом із фішкою: стек із трьох
// займає тепер 78 px замість 98, і саме це «компактніше» видно на оглядовому масштабі, де таких
// стеків на екрані десятки.
const ICON_SLOT_OFFSETS = {
  1: [[0, 0]],
  2: [[-13.5, 0], [13.5, 0]],
  3: [[-27, 0], [0, 0], [27, 0]]
};
const ICON_BADGE_OFFSET = { 1: [1.6, 0], 2: [2.9, 0], 3: [4.5, 0] };
...
//
// Підйом звузився разом із фішкою (−34 → −27, та сама пропорція 24/30): він мусить лишатися рівно
// одним кроком стека, інакше підведений стек або наїде на свій обласний, або відірветься від
// власного центроїда далі, ніж потрібно, щоб їх розвести.
const ICON_TIER_LIFT = -27;
const MAX_ICON_SLOTS = 3;
// Усі чотири шари несуть той самий locationId на тій самій фічі, тож дотик по іконці, по проміжку
// між іконками або по бейджу «+N» відкриває ту саму панель. Саме тому 24-піксельна фішка лишається
// прийнятною ціллю для пальця: ціль — увесь стек разом із проміжками, а не окрема фішка.
...
// Вектор загрози — це ТРЕК: поточні місця цілі за вікно її класу, а не весь ланцюг від першого
// повідомлення. Обрізає сервер (`/api/v1/vectors`, поле `track`): вузли старші за вікно класу випадають,
// повторний візит згортається в один вузол, вузлів щонайбільше чотири. Карта малює рівно те, що
// прийшло, і нічого не дорізає сама — інакше «що вважати поточним» вирішували б дві реалізації.
//
// Один відрізок = один перехід, у якого є джерело, час і рівень доказовості. Три різні шари ліній, бо
// MapLibre не вміє керувати line-dasharray за даними, а різниця між рівнями доказовості мусить бути
// видима, а не описана:
//   transit   — одне повідомлення ствердило сам рух («повз Бровари на Бориспіль»): суцільна лінія;
//   direction — повідомлено напрямок, але не прибуття: штрихова. Нею ж малюється курс голови
//               (`track.heading`) — це той самий рівень: джерело назвало, куди, і не обіцяло прибуття;
...
const vectorLayerIds = ['threat-vector-sequence','threat-vector-direction','threat-vector-transit','threat-vector-nodes','threat-vector-travel','threat-vector-place','threat-vector-arrowhead','threat-vector-class'];
// КОЛІР = КЛАС. Досі всі ланцюги були одного білого кольору, і коли на карті їх десяток, не можна
// було сказати, що саме летить звідки й куди: «Шахед» від балістики відрізняла лише фішка на голові.
// Тепер лінія й вузли треку мають колір сімейства класу, а доказовість, як і раніше, кажуть пунктир і
// вістря — дві осі («що» і «наскільки певно») не ділять одну змінну.
//
// Сімейства, а не десять кольорів: РСЗВ, артилерія й міномети — один бурий, бо їхній «трек» — це
// послідовність місць обстрілу, а розрізняє їх фішка. Червоні відтінки ракет — не колір тривоги:
// тривога — це заливка полігона (#ff4747), а тут лінія в кілька пікселів із власним пунктиром, і
// формою одне з другим не сплутати. Усі кольори світлі й насичені: на темній підкладці дають ≥5:1, на
// найтемнішій заливці тривоги (#6A2124) найслабший, балістичний, — 3.1:1.
const vectorClassColors = {
  uav: '#ffb13d', cruise_missile: '#ff5a4f', ballistic_missile: '#ff2d55', guided_air_bomb: '#e3d04f',
  aviation: '#b58cff', mlrs: '#c98b5a', artillery: '#c98b5a', mortar: '#c98b5a', combined: '#ff7a4d',
  unknown: '#b8c2bc'
};
const vectorColorOf = (threatType) => vectorClassColors[threatType] ?? vectorClassColors.unknown;
// Нейтральне чорнило для того, що належить не класу, а поясненню: підписи місць і вістря. Білий не
// зайнятий жодним станом карти (#ff4747 — тривога, #ffcf8a — наслідки, #8f9b94 — аналітика, #72d6ca —
// суверенітет) і дає ≥7:1 на кожній заливці. Вістря лишається білим на лінії будь-якого класу: воно
// каже «рух ствердило джерело», а не «що летить», і цю заяву не можна пофарбувати в колір класу.
const vectorInk = '#f4f7fa';
...
//                        й назви на її кінцях лишаються єдиним, що показує послідовність.
//
...
// Фішка класу стоїть ПІД головою треку. Зсув саме вертикальний, а не вбік: вістря повернуте за
// курсом, і бічний зсув фішки то накривав би його, то відлітав від нього залежно від того курсу.
// А вниз, а не вгору, тому що над вузлом стоїть назва місця (threat-vector-place, text-offset
// -1.1 em): фішка додається пізніше, тобто лежить вище, і зсунута вгору вона накрила б саме ту
// назву. +30 px лишає просвіт і під вістрям, і під назвою на обох кінцях інтерполяції icon-size.
// Одиниці — пікселі, помножені на icon-size, як і в ICON_SLOT_OFFSETS.
const VECTOR_CLASS_OFFSET = [0, 30];
// Над місцем, де ціль кружляє, по колу ходить іконка класу (VECTOR_ORBIT_RADIUS), і на +30 px нижній
// край орбіти зачіпав би фішку на великому масштабі. Тож лише така голова опускає фішку нижче; решта
// лишається біля свого вузла.
const VECTOR_CLASS_OFFSET_LOITER = [0, 46];
// Кегль підпису віку біля фішки. Названий, бо text-offset міряється в емах САМЕ цього кегля, а фішка —
// у пікселях × icon-size, і зсув підпису доводиться рахувати з обох.
const VECTOR_TAG_TEXT_SIZE = 10.5;
// Стан треку словами. Один словник на карту, легенду й діалог події: стан, названий у трьох місцях
// трьома словами, був би трьома різними станами.
const trackStatusNames = {
  moving: 'рухається', loitering: 'кружляє', passed: 'минула', ended: 'завершено', unclear: 'неясно',
  stale: 'застаріло'
};
// Минула й завершена загроза лишаються на карті блідими, а не зникають одразу: трек, що пропав без
// сліду посеред погляду, читався б як збій. Але поруч із живими вони не мають права кричати.
const TRACK_FADE = { passed: .45, ended: .45 };
...
// Лише першорядні місця (`primary_settlement`, міграція 056): обласні центри, Київ і Севастополь.
// Це ті самі 29 крапок, що й до 056, хоча 056 дала координати майже кожному місту каталогу.
function cityCollection() {
  return { type: 'FeatureCollection', features: locations
    .filter((item) => ['city','special_city'].includes(item.type) && item.primary_settlement
...
//
// Подія, для якої сервер уже віддав трек, свого напрямку тут не малює: трек каже те саме свіжіше —
// голова, її вік і стрілка курсу, названого джерелом. Друга лінія того самого курсу з другою фішкою
// поруч — рівно той безлад, через який на карті не було видно, що куди летить.
function directionCollection() {
  const tracked = trackedEventIds();
  return { type: 'FeatureCollection', features: snapshot.threats.filter((threat) => threat.geometry?.type === 'LineString' && !tracked.has(threat.id)).map((threat) => ({ type: 'Feature', id: threat.id, geometry: threat.geometry, properties: { title: threat.title, origin: threat.origin ?? 'deterministic' } })) };
}

// ------------------------------------------------------------------------------------------------
// Вектори загроз — треки повідомлень
// ------------------------------------------------------------------------------------------------
//
// Шар direction-lines малює threat_events.geometry — одну лінію на подію, з однаковим пунктиром і без
// розбору, звідки вона взялася. Трек — інша річ: у нього власне джерело даних (/api/v1/vectors),
// власна одиниця (відрізок, а не подія) і, головне, кожен відрізок має свій рівень доказовості, який
// мусить читатися з карти. Тому — окремі шари; порядок наявних не змінюється. Спільне в них одне:
// подія з треком малюється лише треком (`directionCollection`).
 ...
 * самі дані треків — тому ключем є тотожність відрізка (`segmentId`: подія й два місця), а чиститься
 ...
 * доки око встигає простежити напрямок, і більше не повертається.
 *
 * Постійний рух дає окремий шар — точка, що їде дугою петлею (`vectorTravelCollection` нижче). Тут
 * ці двоє не сперечаються, а ділять роботу: промальовування каже «цей відрізок щойно зʼявився»,
 * рух каже «ось у цей бік». Обидва однаково не мають права сказати «ціль зараз тут», і жоден із
 * них цього не робить — ані тривалість промальовування, ані фаза руху не беруться з годинника.
 */
...
// ------------------------------------------------------------------------------------------------
// Трек: голова, вік і стан
// ------------------------------------------------------------------------------------------------
//
// Усе, що карта знає про «де ціль зараз», приходить готовим у `vector.track`: сервер порахував голову,
// вік, поріг застарілості й вікно класу, а в режимі Codex міг звірити трек зі швидкою моделлю. Браузер
// нічого з цього не виводить сам — лише показує. Єдина власна арифметика тут — перетворити вік на
// непрозорість і на слова.

/** Індекс голови у `vector.nodes`. Відповідь без треку (такої сервер не шле) лишає голову останньому
 *  вузлу — тому, що й до треків стояв на кінці ланцюга, — а не валить карту. */
function trackHeadIndex(vector) {
  const index = vector.track?.headIndex;
  return Number.isInteger(index) && vector.nodes?.[index] ? index : (vector.nodes?.length ?? 0) - 1;
}

/** Найсвіжіший відрізок, що закінчується в голові: саме його повідомлення поставило голову туди. */
function trackHeadLeg(vector) {
  const headIndex = trackHeadIndex(vector);
  let freshest = null;
  for (const segment of vector.segments ?? []) {
    if (segment.to !== headIndex) continue;
    if (!freshest || (Number(segment.ageSeconds) || 0) < (Number(freshest.ageSeconds) || 0)) freshest = segment;
  }
  return freshest;
}

/** Клас у голові: той, що назвало її повідомлення, або клас події, коли відрізка до голови немає. */
function trackClass(vector) {
  return trackHeadLeg(vector)?.threatType ?? vector.threatType ?? 'unknown';
}

/**
 * Непрозорість за віком повідомлення: 1 — щойно, 0.3 — на межі вікна класу.
 *
 * Старше за вікно сервер не надсилає зовсім, тож нижньої межі досягає лише те, що от-от зникне. Не
 * до нуля: лінія, яку вже не видно, але яка ще лежить на карті, ловила б клік і нічого не пояснювала.
 */
function trackAgeOpacity(ageSeconds, horizonSeconds) {
  const horizon = Number(horizonSeconds);
  const age = Number(ageSeconds);
  if (!(horizon > 0) || !Number.isFinite(age)) return 1;
  return 1 - .7 * Math.min(1, Math.max(0, age / horizon));
}

/** «2 хв» — скільки минуло від повідомлення, яке поставило голову. Не час польоту й не прогноз. */
function trackAgeText(seconds) {
  const minutes = Math.round((Number(seconds) || 0) / 60);
  return minutes < 1 ? '<1 хв' : `${minutes} хв`;
}

/**
 * Підпис біля фішки голови. Вік є завжди, бо свіжість — перше, що треба знати про «де ціль зараз»;
 * стан — лише там, де він змінює прочитання. Застаріле підписується «тому», а не просто хвилинами:
 * «12 хв» біля фішки читалося б як «ще 12 хв», тобто як прогноз.
 */
function trackHeadTag(track) {
  const age = trackAgeText(track?.headAgeSeconds);
  switch (track?.status) {
    case 'loitering': return `кружляє · ${age}`;
    case 'stale': return `${age} тому`;
    case 'passed': return `минула · ${age} тому`;
    case 'ended': return `завершено · ${age} тому`;
    default: return age;
  }
}

/** Множник блідості всього треку за його станом: 1 для живого. */
const trackFade = (vector) => TRACK_FADE[vector.track?.status] ?? 1;

/** Події, що мають трек на карті: їхній власний напрямок не малюється вдруге (`directionCollection`). */
function trackedEventIds() {
  return new Set(vectors.map((vector) => vector.eventId));
}

/**
 * Курс голови — місце, яке повідомлення голови назвало пунктом призначення. Вузлом треку воно не є:
 * туди ціль ніхто не ставив, тож ні крапки, ні назви на ньому немає, лише штрихова лінія з порожнім
 * вістрям — «куди», а не «прибула». Координати в місця може й не бути (громада): тоді курс лишається
 * в діалозі текстом. Минула й завершена загроза курсу не малюють — він уже нічого не каже про те, куди
 * вона летить.
 */
function trackHeadingLine(vector) {
  const track = vector.track;
  if (!track?.heading?.coordinates || track.status === 'passed' || track.status === 'ended') return null;
  const head = vector.nodes?.[trackHeadIndex(vector)];
  if (!head?.coordinates) return null;
  return { id: `vh-${vector.eventId}-${head.locationId}-${track.heading.locationId}`, from: head, to: track.heading };
}

/**
 * Ідентичність відрізка — його два місця, а не позиція в масиві. Трек перевидається з кожним знімком і
 * обрізається з хвоста, тож відрізок, що зсунувся в масиві, під позиційним id позичав би чужий час
 * промальовування. Пара місць у треку унікальна: сервер лишає один відрізок на пару вузлів.
 */
const segmentId = (vector, from, to) => `vs-${vector.eventId}-${from.locationId}-${to.locationId}`;

function vectorSegmentCollection(now = performance.now()) {
  const features = [];
  const live = new Set();
  for (const vector of vectors) {
    const horizon = vector.track?.horizonSeconds;
    const fade = trackFade(vector);
    for (const segment of vector.segments ?? []) {
      ...
      const id = segmentId(vector, from, to);
      live.add(id);
      ...
      features.push({ type: 'Feature', id,
        ...
        properties: { eventId: vector.eventId, basis: segment.basis, evidence: segment.evidenceLevel,
          // Колір — клас, який назвало САМЕ це повідомлення, а не клас події: відрізок про БпЛА на
          // події, яку пізніше назвали комбінованою, лишається кольору БпЛА.
          color: vectorColorOf(segment.threatType ?? vector.threatType),
          opacity: trackAgeOpacity(segment.ageSeconds, horizon) * fade,
          approximate: from.coordinatePrecision === 'approximate' || to.coordinatePrecision === 'approximate',
          label: `${from.name} → ${to.name}` } });
    }
    const heading = trackHeadingLine(vector);
    if (heading) {
      live.add(heading.id);
      const arc = segmentArc(heading.id, heading.from.coordinates, heading.to.coordinates).points;
      features.push({ type: 'Feature', id: heading.id,
        geometry: { type: 'LineString', coordinates: partialArc(arc, vectorDrawProgress(heading.id, now)) },
        // Рівень доказовості курсу — рівно `reported_direction`: джерело назвало напрямок і не обіцяло
        // прибуття. Тому він і малюється шаром штрихових ліній, а не окремим, новим стилем.
        properties: { eventId: vector.eventId, basis: 'reported_direction', heading: true,
          color: vectorColorOf(trackClass(vector)),
          opacity: trackAgeOpacity(vector.track.headAgeSeconds, horizon) * fade,
          approximate: heading.from.coordinatePrecision === 'approximate',
          label: `${heading.from.name} → ${heading.to.name}` } });
    }
  }
  // Відрізок, що зник із відповіді, забирає з собою й свій час початку: інакше мапа росла б увесь
  // час роботи вкладки, а трек, який повернувся б із тим самим id, промальовувався б миттєво.
...
/**
 * Іконка класу, що безперервно їде дугою до голови треку.
 *
 * ЩО ВОНА ЗНАЧИТЬ І ЧОГО НЕ ЗНАЧИТЬ. Вона показує НАПРЯМОК ствердженого руху, те, що трек живий,
 * і — з поправкою на стиснення часу — з якою приблизно швидкістю рухається ЦЕЙ КЛАС зброї.
 * Вона НЕ показує, де ціль зараз: позиція береться з фази анімації, а не з годинника, і жодне
 * спостереження за конкретною ціллю в цю фазу не входить. `elapsedSeconds` дорівнює нулю рівно на
 * тих відрізках, де рух ствердило джерело, тож виміряної швидкості в даних немає й не було.
 *
 * Саме тому цикл ПЕТЛЯ, а не один прохід: точка, що проїхала й зупинилася в кінці, читалася б як
 * «долетіло», а точка, привʼязана до часу, — як «зараз тут». Те, що повторюється, читається як
 * схема, а не як телеметрія.
 *
 * ОДНА на трек, лише на відрізку, що закінчується в голові, і лише поки трек `moving`. Раніше гліф
 * їхав КОЖНИМ відрізком кожного ланцюга, і десять одночасних петель на одному ланцюзі читалися як
 * десять цілей — саме з цього почалася скарга «не видно, що звідки куди». Історія треку лежить
 * нерухомою лінією; рухається лише останній крок. Ціль, що кружляє, не їде нікуди — її іконка ходить
 * малим колом над місцем (`VECTOR_ORBIT_RADIUS`). Застарілий, минулий і завершений трек не рухається
 * зовсім: рух на ньому стверджував би, що він живий.
 *
 * Точка їде ЛИШЕ по вже домальованому відрізку: інакше вона бігла б попереду лінії, якої ще немає.
 */
/**
 * Типова крейсерська швидкість класу, км/год — і чому це не порушує ту саму межу.
 *
 * Це ПУБЛІЧНА характеристика типу зброї, а не дані про конкретну ціль. Система як не знала, так і
 * не знає, з якою швидкістю летить те, про що написало джерело: у ланцюзі немає ані швидкості, ані
 * навіть тривалості на тих ланках, де рух ствердили (`elapsedSeconds` там завжди нуль). Тому число
 * звідси НІКОЛИ не потрапляє ні в текст, ні в API, ні в оцінку ризику — воно живе рівно в одному
 * місці: у тривалості анімації.
 *
 * Що воно дає читачеві: довгий відрізок тепер триває довше за короткий, а «Шахед» повзе там, де
 * крилата ракета проскакує. Раніше всі точки проходили будь-яку відстань за однакові 2.6 с, і це
 * читалося як твердження, що всі вони однакові — гірша неправда, ніж наближення.
 *
 * Наземні класи (артилерія, міномети, РСЗВ) у ланцюгах не подорожують: їхні «відрізки» — це
 * послідовність місць обстрілу, а не переліт. Їм дано повільне значення, щоб точка не смикалася.
 */
const THREAT_CRUISE_KMH = {
  uav: 180,               // ударний БпЛА типу Shahed-136
  cruise_missile: 800,    // дозвукова крилата
  ballistic_missile: 3600,
  guided_air_bomb: 700,   // планує після скидання
  aviation: 800,
  mlrs: 300, artillery: 300, mortar: 300,
  combined: 500,
  unknown: 500
};

/**
 * У скільки разів анімація швидша за реальність.
 *
 * Без стиснення це було б непридатне: «Шахед» долає 280 км між Миколаєвом і Дніпром за півтори
 * години, і гліф стояв би на місці.
 *
 * Шістдесят — тобто секунда анімації за хвилину реального часу. Перша спроба стояла на 200, і на
 * живій карті це дало 48–221 тисячу км/год екранної швидкості: гліфи проскакували ланку швидше,
 * ніж око встигало за ними, тобто рівно та скарга, з якої все почалося. На 60 типова ланка «Шахеда»
 * триває близько пʼятдесяти секунд, крилатої ракети — близько одинадцяти, і різниця між класами
 * стає видимою, а не теоретичною.
 */
const VECTOR_TIME_COMPRESSION = 60;
...
// Кружляння над місцем. Радіус — у пікселях × icon-size шару руху (0.6–0.92), тобто 10–15 px на
// екрані: досить, щоб іконку було видно поруч із крапкою, і замало, щоб коло прочитали як маршрут
// довкола міста. Період сталий і не залежить ні від класу, ні від часу: коло каже «кружляє над цим
// місцем», а не «облітає його за стільки-то хвилин».
const VECTOR_ORBIT_RADIUS = 16;
const VECTOR_ORBIT_MS = 6000;
...
/** Скільки триває один прохід точки цим відрізком. */
function vectorTravelDurationMs(from, to, threatType) {
  const kmh = THREAT_CRUISE_KMH[threatType] ?? THREAT_CRUISE_KMH.unknown;
  const hours = haversineKm(from, to) / kmh;
  const ms = hours * 3600 * 1000 / VECTOR_TIME_COMPRESSION;
  return Math.min(VECTOR_TRAVEL_MAX_MS, Math.max(VECTOR_TRAVEL_MIN_MS, ms));
}

/** Точка на поліламаній за часткою `t`, лінійно між сусідніми вузлами. */
function arcPointAt(points, t) {
  const span = points.length - 1;
  if (span <= 0) return points[0];
  const exact = Math.min(span, Math.max(0, t * span));
...
/** Вузол, над яким ціль кружляє: позначений сервером (`loiter`), а без позначки — голова. */
function trackLoiterNode(vector) {
  return (vector.nodes ?? []).find((node) => node.loiter) ?? vector.nodes?.[trackHeadIndex(vector)] ?? null;
}

function vectorTravelCollection(now = performance.now()) {
  const features = [];
  if (!motionAllowed()) return { type: 'FeatureCollection', features };
  for (const vector of vectors) {
    const status = vector.track?.status ?? 'moving';
    if (status === 'loitering') {
      const place = trackLoiterNode(vector);
      if (!place?.coordinates) continue;
      // Фаза — з петлі, як і в руху по дузі: кут залежить від мілісекунди циклу, а не від того, коли
      // про ціль писали.
      const angle = 2 * Math.PI * ((now % VECTOR_ORBIT_MS) / VECTOR_ORBIT_MS);
      features.push({ type: 'Feature', id: `vt-${vector.eventId}`,
        geometry: { type: 'Point', coordinates: place.coordinates },
        properties: { basis: 'loiter', label: place.name,
          offset: [Math.cos(angle) * VECTOR_ORBIT_RADIUS, Math.sin(angle) * VECTOR_ORBIT_RADIUS],
          icon: iconImageId(trackClass(vector), vectorClassTone(trackHeadLeg(vector)?.evidenceLevel)) } });
      continue;
    }
    if (status !== 'moving') continue;
    const segment = trackHeadLeg(vector);
    if (!segment?.drawable) continue;
    const from = vector.nodes[segment.from];
    const to = vector.nodes[segment.to];
    if (!from?.coordinates || !to?.coordinates) continue;
    ...
    // Тривалість — власна для відрізка, бо в кожного своя довжина. Спільна фаза й була тим, через
    // що всі точки долали будь-яку відстань за однаковий час.
    ...
    features.push({ type: 'Feature', id: `vt-${vector.eventId}`,
      ...
      // для стеків територій і для фішки на голові треку; третього конвеєра іконок тут немає.
      // Один рухомий символ відповідає одразу на два питання — «що» і «куди», — і робить це без
      // жодного слова на карті.
      properties: { basis: segment.basis, label: `${from.name} → ${to.name}`, offset: [0, 0],
        icon: iconImageId(segment.threatType ?? vector.threatType ?? 'unknown',
          vectorClassTone(segment.evidenceLevel)) } });
  }
  return { type: 'FeatureCollection', features };
}

/**
 * Крутить рух, поки на карті є хоч один домальований відрізок.
 *
 * На відміну від промальовування цей цикл сам не закінчується — його закінчує відсутність
 * відрізків або `stopVectorTravel`. Браузер зупиняє `requestAnimationFrame` у прихованій вкладці,
 * тож фонова вкладка не крутить кадри й нічого не коштує.
 */
function runVectorTravel() {
  ...
  const step = () => {
    ...
    // на першому ж кадрі після завантаження жоден відрізок ще не домальовано (точка не має права
    // бігти поперед лінії), набір порожній, цикл виходить — і піднімається аж на наступному
    // `applyVectors`, тобто через пів хвилини. Перевірено на живій карті: `travelDots: 0`.
    //
    // `vectorDrawStart` тримає рівно ті відрізки, які зараз на карті, і сам чиститься від зниклих
    // у `vectorSegmentCollection`. Тож коли ланцюгів не лишається, цикл спиняється сам.
    if (collection.features.length || vectorDrawStart.size) vectorTravelFrame = requestAnimationFrame(step);
  };
  vectorTravelFrame = requestAnimationFrame(step);
}

function stopVectorTravel() {
  if (vectorTravelFrame === null) return;
  cancelAnimationFrame(vectorTravelFrame);
  vectorTravelFrame = null;
}

/**
 * Показова форма назви місця для підпису на карті.
 *
 * Скорочуються рівно два родові слова, і обидва — ті, що повторюються в кожній другій назві й не
 * розрізняють нічого: «область» і «район». Власну назву не чіпаємо ніколи, бо саме вона й відповідає
 * на питання «звідки».
 */
function shortPlace(name) {
  return String(name ?? '')
    .replace(/\s+область$/iu, ' обл.')
    .replace(/\s+район$/iu, ' р-н');
}

/**
 * Вузли треку. Назву несуть лише голова й початок: відповідь на «звідки й куди» — це два кінці, а
 * проміжні місця лишаються малими крапками без підпису. Підпис на кожній крапці перетворював три
 * ланцюги на стіну назв, яку читач не міг розібрати.
 *
 * Крапка стоїть там, куди веде намальований відрізок, — і ще в голові, навіть без відрізка: трек із
 * самої голови (ціль кружляє над одним місцем, або джерело назвало лише курс) сервер публікує свідомо,
 * і голова в ньому — головне твердження.
 */
function vectorNodeCollection() {
  ...
  for (const vector of vectors) {
    ...
    const horizon = vector.track?.horizonSeconds;
    const fade = trackFade(vector);
    // Застарілий трек фарбує вузли тим самим сірим, що й фішку голови: лінії лишаються кольору класу
    // (що летіло), а крапки кажуть, що нового про це давно не чули — навіть там, де фішку голови
    // сховала колізія.
    const color = vector.track?.status === 'stale' ? analyticColor : vectorColorOf(trackClass(vector));
    const drawn = new Set();
    for (const segment of vector.segments ?? []) {
      if (segment.drawable) { drawn.add(segment.from); drawn.add(segment.to); }
    }
    for (const [index, node] of (vector.nodes ?? []).entries()) {
      if (!node.coordinates || (index !== headIndex && !drawn.has(index))) continue;
      const role = index === headIndex ? 'head' : node.role === 'origin' ? 'origin' : 'trail';
      features.push({ type: 'Feature', id: `vn-${vector.eventId}-${node.locationId}`,
        geometry: { type: 'Point', coordinates: node.coordinates },
        // «Дніпропетровська область» — 24 символи над крапкою в шість пікселів. Скорочення суто
        // показове й живе лише тут: цю властивість читає рівно один шар підпису, а картка події,
        // діалог і сам API віддають назву повністю.
        properties: { eventId: vector.eventId, role, name: role === 'trail' ? '' : shortPlace(node.name),
          color, opacity: trackAgeOpacity(node.ageSeconds, horizon) * fade,
...
// 'consequence' тут неможливий: трек складено з тверджень про рух, а не з наслідків на місці.
// Сірий 'analytic' фішка голови бере лише тоді, коли голова застаріла (`vectorHeadCollection`).
function vectorClassTone(evidenceLevel) {
  return evidenceLevel === 'official' || evidenceLevel === 'confirmed' ? 'confirmed' : 'reported';
}

/**
 * Голови треків: вістря на кінці кожного відрізка, рух у якому ствердило джерело, порожнє вістря
 * курсу, названого для голови, і рівно одна фішка класу на трек — під головою, з віком поруч.
 *
 ...
 *
 * Фішка одна на трек і стоїть там, де сервер поставив голову (`track.headIndex`). Застаріла голова
 * бере сіру фішку — ту саму сіру, якою карта позначає все, що не є живим твердженням, — а минула й
 * завершена бліднуть: стан голови видно раніше, ніж прочитано підпис.
 *
 * Лінії напрямку (`threat.geometry` типу LineString) отримують те саме вістря й ту саму фішку, якщо
 * події не має серед треків. Свого запиту для них не зʼявилося: `snapshot.threats[]` — це LiveEvent, у
 * якого threatType і evidenceLevel уже лежать поруч із геометрією, тож серверу тут не додано нічого.
 */
function vectorHeadCollection() {
  ...
  //
  // Текстової назви класу на карті немає навмисно: одного разу її додали окремим шаром, і вона
  // перетворила три ланцюги на дюжину однакових написів. Єдиний текст біля фішки — `tag`, вік голови
  // й стан, коли він змінює прочитання («2 хв», «кружляє · 2 хв», «12 хв тому»): свіжість — це те, чого
  // гліф сказати не може, а без неї голова, якій двадцять хвилин, виглядає так само, як щойно названа.
  //
  // Кількості тут немає й бути не може: класифікатор чисел не витягує, тож будь-яке число поруч із
  // класом було б нашим припущенням, а не заявою джерела.
  const chip = (id, point, threatType, tone, label, extra = {}) => ({
    type: 'Feature', id,
    geometry: { type: 'Point', coordinates: point },
    properties: { kind: 'class', icon: iconImageId(threatType, tone), label, ...extra }
  });
  ...
  const endBearing = (from, to) => {
    const arc = vectorArc(from, to);
    return segmentBearing(arc[arc.length - 2], arc[arc.length - 1]);
  };
  ...
  for (const vector of vectors) {
    for (const segment of vector.segments ?? []) {
      ...
      const to = vector.nodes[segment.to];
      if (!from?.coordinates || !to?.coordinates) continue;
      const bearing = endBearing(from.coordinates, to.coordinates);
      if (bearing === null) continue;
      features.push(arrow(`va-${vector.eventId}-${from.locationId}-${to.locationId}`, to.coordinates, bearing,
        image, segment.basis, `${from.name} → ${to.name}`));
    }
    const heading = trackHeadingLine(vector);
    const headingBearing = heading ? endBearing(heading.from.coordinates, heading.to.coordinates) : null;
    if (headingBearing !== null) {
      features.push(arrow(`vha-${vector.eventId}`, heading.to.coordinates, headingBearing,
        ARROW_BASIS_IMAGES.reported_direction, 'reported_direction', `${heading.from.name} → ${heading.to.name}`));
    }
    const head = vector.nodes?.[trackHeadIndex(vector)];
    if (!head?.coordinates) continue;
    const track = vector.track ?? {};
    const status = track.status ?? 'moving';
    const tone = status === 'stale' ? 'analytic' : vectorClassTone(trackHeadLeg(vector)?.evidenceLevel);
    features.push(chip(`vc-${vector.eventId}`, head.coordinates, trackClass(vector), tone, head.name,
      { status, tag: trackHeadTag(track), fade: trackFade(vector) }));
  }

  const tracked = trackedEventIds();
  for (const threat of snapshot?.threats ?? []) {
    if (tracked.has(threat.id)) continue;
    ...
    if (bearing === null) continue;
    // Той самий рівень, що й у reported_direction треку, і з тієї самої причини: геометрія події
...
async function loadVectors() {
  try {
    ...
    vectors = data.items;
    // Єдине місце, де дані треків змінюються, — отже єдине, де кеш дуг стає брехнею. Невдала
...
function applyVectors() {
  if (mapLayersReady && map?.getSource('threat-vector-segments')) {
    ...
    // Лінії напрямку подій читають той самий перелік треків (`directionCollection` пропускає події з
    // треком), тож перелік змінився — перевидаються й вони. Інакше між знімками подія, трек якої щойно
    // зʼявився, малювалася б двічі, а та, чий трек зник, — жодного разу.
    if (snapshot) map.getSource('reported-directions')?.setData(directionCollection());
    ...
    runVectorDraw();
    // Рух піднімається тим самим шляхом і теж спиняється сам, коли рухати нічого. Виклик тут, а не
    // всередині `runVectorDraw`: промальовування закінчується, рух — ні, і звʼязати їх означало б,
    // що зупинка одного гасить інший.
    map.getSource('threat-vector-travel')?.setData(vectorTravelCollection());
    runVectorTravel();
  }
  renderVectorLegend();
}
...
function vectorArrowImage(filled) {
  ...
  ctx.closePath();
  // Темний обвід іде першим і ширшим за саму фігуру. Вістря сідає на кінець кольорової лінії, на
  // підпис міста або на світлий гліф іконки — обвід відділяє його від будь-чого, а не лише від того,
  // задля чого його додали.
  ctx.strokeStyle = '#06080c'; ctx.lineWidth = 2.6; ctx.lineJoin = 'round'; ctx.stroke();
  if (filled) {
    ctx.fillStyle = vectorInk; ctx.fill();
  }
  ctx.strokeStyle = vectorInk; ctx.lineWidth = filled ? 1 : 1.8; ctx.stroke();
...
function addVectorLayers() {
  // Якір: alert-oblast-label. Геометрія треку лягає НАД заливками й контурами станів території, але
  ...
  // Зверху треку лишається тільки те, що додано без beforeId: лінія напрямку і, з етапу 2,
  ...
  map.addSource('threat-vector-travel', { type: 'geojson', data: vectorTravelCollection() });
  // Колір і непрозорість — із фічі: колір каже клас (`vectorClassColors`), непрозорість — вік
  // повідомлення (`trackAgeOpacity`). Пунктир лишається за рівнем доказовості, як і був: MapLibre
  // не вміє line-dasharray за даними, і саме тому шарів три.
  ...
  map.addLayer({ id: 'threat-vector-sequence', type: 'line', source: 'threat-vector-segments',
    ...
    paint: { 'line-color': color, 'line-width': ['interpolate',['linear'],['zoom'],5,1.5,9,3],
      'line-opacity': opacity, 'line-dasharray': [0.5,2.4] } }, anchor);
  map.addLayer({ id: 'threat-vector-direction', type: 'line', source: 'threat-vector-segments',
    ...
    paint: { 'line-color': color, 'line-width': ['interpolate',['linear'],['zoom'],5,2,9,3.6],
      'line-opacity': opacity, 'line-dasharray': [3,1.6] } }, anchor);
  map.addLayer({ id: 'threat-vector-transit', type: 'line', source: 'threat-vector-segments',
    ...
    paint: { 'line-color': color, 'line-width': ['interpolate',['linear'],['zoom'],5,2.4,9,4.4],
      'line-opacity': opacity } }, anchor);
  // Порожнє коло = наближена координата: центроїд полігона району або центр території громади. Це
  // наближення, і воно позначене формою, а не лише в тексті легенди. Проміжні вузли — малі крапки:
  // голова й початок відповідають на «звідки й куди», решта лише тримає форму лінії.
  const trail = ['==', ['get','role'], 'trail'];
  map.addLayer({ id: 'threat-vector-nodes', type: 'circle', source: 'threat-vector-points', paint: {
    'circle-radius': ['interpolate',['linear'],['zoom'],5,['case',trail,2,3.2],9,['case',trail,3.4,6]],
    // Порожнє коло лишається порожнім, але темним, а не прозорим: крізь прозоре просвічувала б
    // заливка тривоги, і «наближена координата» на червоному полігоні читалася б як залита. Залите
    // коло має темний обвід, порожнє — обвід кольору класу: форма та сама на будь-якій підкладці.
    'circle-color': ['case',['get','approximate'],'rgba(6,8,12,.72)',color],
    'circle-opacity': opacity, 'circle-stroke-width': ['case',trail,1.1,1.6],
    'circle-stroke-color': ['case',['get','approximate'],color,'#06080c'], 'circle-stroke-opacity': opacity
  } }, anchor);
  // Рухома іконка лежить НАД лініями й ПІД вістрями: вона пояснює лінію, по якій їде, і не має
  // права затулити вістря, яке є заявою джерела про рух.
  //
  // `icon-allow-overlap` і `icon-ignore-placement` — обидва true, і це не недбалість. Символ, що
  // рухається, не можна підпорядковувати колізіям: він гаснув би й спалахував на кожному кадрі,
  // натикаючись то на підпис міста, то на сусідній стек, і рух перетворився б на миготіння. З тієї
  // самої причини він нікого не відштовхує — інакше кожен його крок пересував би чужі підписи.
  //
  // НЕ обертається. Гліфи намальовані в одному положенні, і `icon-rotate` тут зробив би з депікції
  // класу стрілку, що вказує напрямок, — те саме, чого не роблять фішки територій. Напрямок каже
  // сам рух і вістря в кінці лінії.
  //
  // Кружляння — той самий символ на вузлі, зсунутий по колу `icon-offset`: зсув у пікселях не
  // розтягується з масштабом, тож коло лишається малим над місцем, а не стає маршрутом довкола міста.
  map.addLayer({ id: 'threat-vector-travel', type: 'symbol', source: 'threat-vector-travel', layout: {
    'icon-image': ['get','icon'],
    'icon-size': ['interpolate',['linear'],['zoom'],5,.6,9,.92],
    'icon-offset': ['array', 'number', 2, ['get','offset']],
    'icon-allow-overlap': true, 'icon-ignore-placement': true
  } }, anchor);
  // Підпис вузла — НАЗВА МІСЦЯ, а не його порядковий номер у ланцюзі.
  //
  // Тут стояв `order` = `node.index + 1`, і на карті це давало самотні «3», «4», «5» біля білих
  // крапок. Число було правдиве й нечитне водночас: щоб зрозуміти «4», треба було знати, що
  // ланцюг — це послідовність повідомлень, і що це четверте з них. Жодна легенда цього не
  // пояснювала, а порядок і так уже закодовано двічі — самою лінією та вістрям на її кінці.
  //
  // Назва місця відповідає на питання, яке читач ставить насправді: звідки й куди. Порядок вона не
  // втрачає, бо він лишається у формі лінії.
  //
  // allow-overlap ЛИШАЄТЬСЯ, і це не інерція від номера, який тут стояв.
  //
  // Першою редакцією цієї заміни колізії було ввімкнено — довга назва здавалася надто важкою, щоб
  // ставити її над усім. На карті вийшло гірше за номер: підписи зникали рівно там, де густо, тобто
  // саме там, де читач і питає «звідки й куди». Базові підписи карти вигравали в них місце, і
  // ланцюг знову лишався без кінців.
  //
  // Тому вектор виграє в базової карти, але не в самого себе: `ignore-placement` НЕ ставимо, тож
  // підпис вузла й далі відштовхує інші символи, а стеки територій обходять його, а не друкуються
  // крізь нього.
  //
  // Назву мають лише голова й початок треку (`vectorNodeCollection`): у проміжного вузла порожній
  // рядок, і шар для нього нічого не друкує.
  map.addLayer({ id: 'threat-vector-place', type: 'symbol', source: 'threat-vector-points', minzoom: 5.6, layout: {
    'text-field': ['get','name'], 'text-size': 10.5, 'text-offset': [0,-1.1], 'text-anchor': 'bottom',
    'text-font': ['Noto Sans Regular'], 'text-allow-overlap': true, 'text-max-width': 9,
    'text-padding': 3
    // Підпис — пояснення, а не клас, тож нейтральне чорнило, а не колір треку: назва кольору
    // балістики на червоній заливці тривоги зникала б разом із нею. Бліднути з віком підпис може
    // лише до .6 — старий, але ще показаний трек мусить лишатися прочитним.
  }, paint: { 'text-color': vectorInk, 'text-opacity': ['max', .6, opacity],
    'text-halo-color': '#06080c', 'text-halo-width': 1.8 } }, anchor);
  // Голови треку додаються ПІСЛЯ всієї сімʼї threat-vector-*, тобто над нею: вістря мусить лежати
  ...
  //
  // Підпис віку (`tag`) стоїть праворуч від фішки. icon-offset множиться на icon-size, а text-offset
  // міряється в емах кегля, тож зсув підпису рахується окремо для обох кінців інтерполяції
  // icon-size: обидва лінійні по зуму між тими самими зупинками й тому збігаються на всьому проміжку.
  //
  // Шар існує і без зображень — тоді лише з підписом. Застаріле мусить бути видно як застаріле навіть
  // тоді, коли canvas не дав намалювати жодної фішки.
  const loitering = ['==', ['get','status'], 'loitering'];
  const tagOffset = (size) => ['case', loitering,
    ['literal', [(12 * size + 3) / VECTOR_TAG_TEXT_SIZE, VECTOR_CLASS_OFFSET_LOITER[1] * size / VECTOR_TAG_TEXT_SIZE]],
    ['literal', [(12 * size + 3) / VECTOR_TAG_TEXT_SIZE, VECTOR_CLASS_OFFSET[1] * size / VECTOR_TAG_TEXT_SIZE]]];
  map.addLayer({ id: 'threat-vector-class', type: 'symbol', source: 'threat-vector-heads',
    filter: ['==', ['get','kind'], 'class'], layout: {
      ...(iconImagesReady ? {
        ...
        'icon-offset': ['case', loitering, ['literal', VECTOR_CLASS_OFFSET_LOITER], ['literal', VECTOR_CLASS_OFFSET]],
        'icon-padding': 4
      } : {}),
      'text-field': ['get','tag'], 'text-size': VECTOR_TAG_TEXT_SIZE, 'text-font': ['Noto Sans Regular'],
      'text-anchor': 'left',
      'text-offset': ['interpolate',['linear'],['zoom'],5,tagOffset(.62),9,tagOffset(.86)]
    }, paint: {
      'icon-opacity': ['get','fade'],
      'text-color': vectorInk, 'text-opacity': ['get','fade'], 'text-halo-color': '#06080c', 'text-halo-width': 1.6
    } }, anchor);
}
...
function vectorLegendElement() {
  ...
  if (!legend) {
    ...
    // лежить хоч один трек, і жодного разу раніше.
...
// Сімейства кольорів треку в легенді — тими самими короткими словами, що й сітка гліфів «Загрози на
// карті». Наземні класи — один рядок, бо й колір у них один.
const vectorLegendFamilies = [
  ['uav', 'БпЛА'], ['cruise_missile', 'Крилаті'], ['ballistic_missile', 'Балістика'], ['guided_air_bomb', 'КАБ'],
  ['aviation', 'Авіація'], ['combined', 'Комбінована'], ['mlrs', 'РСЗВ, артилерія, міномети'], ['unknown', 'Невизначена']
];

function renderVectorLegend() {
  const legend = vectorLegendElement();
  if (!legend) return;
  const drawn = vectorSegmentCollection().features.filter((feature) => !feature.properties.heading).length;
  // Вістря лічимо окремо, бо їх дають ДВА джерела: треки і лінії напрямку самих подій. Подія з
  // геометрією-лінією, у якої трек ще не склався, лишила б карту зі стрілками й без жодного
  // рядка, який пояснює, що стрілка означає. Легенда мусить існувати рівно тоді, коли на карті є
  // хоч що-небудь із того, що вона пояснює, — і трек із самої голови теж.
  const pointed = vectorHeadCollection().features.filter((feature) => feature.properties.kind === 'arrow').length;
  const tracks = vectors.filter((vector) => vector.nodes?.[trackHeadIndex(vector)]?.coordinates).length;
  const stale = vectors.filter((vector) => vector.track?.status === 'stale').length;
  const hidden = vectors.reduce((sum, vector) => sum + (vector.segments ?? []).filter((segment) => !segment.drawable).length, 0);
  legend.hidden = !tracks && !drawn && !pointed;
  if (legend.hidden) return;
  legend.open = vectorLegendOpen ?? false;
  const swatch = (style) => `<i class="legend-swatch" style="height:0;border:0;border-top:2px solid ${vectorInk};${style}"></i>`;
  ...
  const family = ([type, label]) => `<li><i class="legend-swatch legend-line" style="color:${vectorColorOf(type)}"></i><span>${escapeHtml(label)}</span></li>`;
  // Вікна класів — ті, що сервер надіслав для треків на карті зараз, а не таблиця, переписана сюди:
  // друга копія розійшлася б із першою мовчки, а легенда пояснювала б вікно, якого вже немає.
  const windows = new Map();
  for (const vector of vectors) {
    const minutes = Math.round(Number(vector.track?.horizonSeconds) / 60);
    if (minutes > 0) windows.set(threatIconShortLabels[trackClass(vector)] ?? trackClass(vector), minutes);
  }
  const windowText = [...windows].map(([name, minutes]) => `${name} — ${minutes} хв`).join(', ');
  const summary = tracks
    ? `${tracks} ${pluralUk(tracks, 'трек', 'треки', 'треків')}${stale ? ` · ${stale} ${pluralUk(stale, 'застарілий', 'застарілі', 'застарілих')}` : ''}`
    : `${pointed} напрямк${pointed === 1 ? '' : 'ів'}`;
  legend.innerHTML = `<summary><i class="swatch threat"></i><span class="legend-title">Треки загроз</span><span class="legend-sum">${summary}</span><span class="legend-caret" aria-hidden="true">▾</span></summary>
    <div class="legend-body">
      <p class="legend-warning">Трек — останні місця, які джерела назвали для цілі, за вікно її класу; старіші повідомлення прибрано з карти й лишено в картці події. Це схема <b>повідомлень</b> із часом і джерелом, а не траєкторія польоту: лінія показує, що і коли повідомили, а не куди прямує ціль. Система не прогнозує ціль, влучання або маршрут.</p>
      <ul class="legend-rows legend-families">${vectorLegendFamilies.map(family).join('')}</ul>
      <ul class="legend-rows">
        <li><i class="legend-swatch legend-fade"></i><span>Яскрава лінія — свіже повідомлення; до межі вікна класу вона тьмяніє до третини.${windowText ? ` Вікно зараз: ${escapeHtml(windowText)}.` : ''}</span></li>
        ...
        <li>${arrowSwatch(false)}<span>Порожнє вістря — джерело назвало курс, але не прибуття. Так само, штриховою лінією, позначено курс від голови треку до місця, яке назвало її повідомлення.</span></li>
        <li>${swatch('border-top-style:dotted;opacity:.5')}<span><b>На крапковій лінії вістря немає ніколи</b> — стрілка на ній була б твердженням про рух, якого не робило жодне джерело. Порядок читається з самої лінії й назв на її кінцях: це порядок повідомлень, а не шлях.</span></li>
      </ul>
      <ul class="legend-rows legend-states">
        <li><i class="legend-chip"></i><span><b>Голова</b>фішка класу й вік останнього повідомлення («2 хв»). Назву мають лише голова й початок треку</span></li>
        <li><i class="legend-chip"></i><span><b>Рухається</b>іконка класу їде останнім відрізком до голови — одна на трек</span></li>
        <li><i class="legend-chip"></i><span><b>Кружляє</b>іконка ходить малим колом над місцем, де ціль повторно називали</span></li>
        <li><i class="legend-chip stale"></i><span><b>Застаріло</b>сіра фішка й «N хв тому»: нових повідомлень про ціль немає довше за поріг класу. Руху немає</span></li>
        <li><i class="legend-chip faded"></i><span><b>Минула · завершено</b>блідий трек без руху; за кілька хвилин він зникне</span></li>
      </ul>
      <p class="legend-note">Швидкість іконки — типова для класу зі стисненням часу, а не виміряна швидкість цілі; коли анімацію вимкнено в системі, рухомої іконки немає зовсім. Трек будують правила; у режимі Codex швидка модель може уточнити голову й стан — лише з місць, які назвали джерела, — і тоді картка події каже «Оцінка моделі».</p>
      <p class="legend-note">Порожнє коло — наближена координата: для району це центроїд його полігона, для громади — центр її території. Це наближення до території, а не місце.${hidden ? ` ${hidden} відрізк${hidden === 1 ? '' : 'ів'} не намальовано взагалі — для цих територій контуру немає; вони лишаються в картці події текстом.` : ''}</p>
    </div>`;
}

/**
 * Стан треку словами — над історією ланцюга в діалозі події.
 *
 * Діалог — єдина поверхня, де на пояснення є місце цілим реченням, тож тут словами сказано те, що
 * карта каже кольором і рухом: у якому стані голова, де вона й скільки їй хвилин, куди, за словами
 * джерела, прямує ціль. Трек, який уточнила модель, підписаний як оцінка моделі — з назвою моделі й
 * впевненістю, — і ніколи як факт: модель лише впорядкувала місця, які назвали джерела.
 */
function vectorTrackHtml(vector) {
  const track = vector.track;
  if (!track) return '';
  const head = vector.nodes?.[track.headIndex];
  const status = trackStatusNames[track.status] ?? String(track.status ?? '');
  const facts = [
    status ? `<b>${escapeHtml(status[0].toUpperCase() + status.slice(1))}</b>` : '',
    head ? `голова — ${escapeHtml(head.name)}, ${escapeHtml(trackAgeText(track.headAgeSeconds))} тому` : '',
    track.heading ? `курс, названий джерелом, — ${escapeHtml(track.heading.name)}` : ''
  ].filter(Boolean).join(' · ');
  const minutes = (seconds) => Math.max(1, Math.round((Number(seconds) || 0) / 60));
  const windowNote = `Трек — повідомлення за останні ${minutes(track.horizonSeconds)} хв, вікно цього класу; без нових `
    + `${minutes(track.staleAfterSeconds)} хв голова вважається застарілою. Старіші переходи нижче позначено як історію — на карті їх уже немає.`;
  const confidence = probabilityText(track.confidence);
  const model = track.basis === 'model'
    ? `<div class="origin-note track-model"><strong>Оцінка моделі: ${escapeHtml(track.summary || status)}</strong><p>${escapeHtml(track.model ?? 'модель')}${confidence ? ` · впевненість ${escapeHtml(confidence)}` : ''}. `
      + 'Модель лише впорядкувала місця, які назвали джерела: подій, тривог і відбоїв вона не створює й не змінює, а за будь-якого збою карта малює трек за правилами.</p></div>'
    : '';
  return `<p class="track-status${track.status === 'stale' ? ' is-stale' : ''}">${facts}</p>${model}<p class="track-window">${escapeHtml(windowNote)}</p>`;
}

function vectorChainHtml(vector) {
  if (!vector?.segments?.length && !vector?.track) return '';
  const horizon = Number(vector.track?.horizonSeconds);
  const rows = (vector.segments ?? []).map((segment) => {
    ...
    // Наближеність буває двох родів (міграція 056): у району координати в каталозі немає, і точку
    // взято з центроїда його полігона; у громади вона в каталозі є, але це центр її території. Підпис
    // про «центроїд району» під громадою називав би не ту територію, тож він лише там, де всі
    // наближені кінці — справді районні.
    const approximateEnds = [from, to].filter((node) => node?.coordinatePrecision === 'approximate');
    const approximate = !approximateEnds.length ? ''
      : approximateEnds.every((node) => node.coordinateSource === 'raion_centroid')
        ? '<small>Координата району наближена — центроїд полігона.</small>'
        : '<small>Координата наближена — центр території, а не точне місце.</small>';
    const undrawn = segment.drawable ? '' : '<small>Немає координат — на карті не показано.</small>';
    // Історія — перехід старший за вікно класу: сервер лишає його тут, у діалозі, але на карту вже не
    // віддає. Позначка словом, а не лише блідістю: інакше рядок, якого немає на карті, читався б як
    // той, що на ній є.
    const history = horizon > 0 && Number(segment.ageSeconds) > horizon;
    ...
    return `<li${history ? ' class="is-history"' : ''}><time>${shortTime(segment.reportedAt)}</time> <b>${escapeHtml(from?.name ?? '?')} → ${escapeHtml(to?.name ?? '?')}</b>
      ...
      <br><small>${history ? 'історія · ' : ''}${escapeHtml(vectorBasisLabels[segment.basis] ?? segment.basis)} · ${escapeHtml(segment.source?.name ?? 'джерело не вказано')} · ${escapeHtml(gap)}${corroboration}</small>
      ${segment.statement ? `<br><small>«${escapeHtml(segment.statement)}»</small>` : ''}${drift}${approximate}${undrawn}</li>`;
  }).join('');
  const span = vector.span ?? {};
  const nodes = vector.nodes?.length ?? 0;
  const legs = vector.segments?.length ?? 0;
  ...
  return `<h3>Трек загрози</h3>
    ${vectorTrackHtml(vector)}
    <p class="detail-summary">${moving}${span.sourceCount ?? 0} джерел${span.sourceCount === 1 ? 'о' : ''} за ${Math.max(1, Math.round((span.elapsedSeconds ?? 0) / 60))} хв · ${nodes} точ${nodes === 1 ? 'ка' : 'ок'} · ${legs} перехід${legs === 1 ? '' : 'ів'}</p>
    ${rows ? `<ol class="update-list">${rows}</ol>` : ''}
...
function threatIconImage(threatType, tone) {
  ...
  // 1. фішка — коло, а не заокруглений квадрат. Круг забирає на чверть менше площі при тій самій
  //    видимій величині гліфа, а на карті ще й читається як маркер місця, тоді як квадрат читався
  //    як кнопка. Радіус у половину сторони перетворює той самий примітив на коло.
  roundedRectPath(ctx, 0.75, 0.75, ICON_CHIP_PX - 1.5, ICON_CHIP_PX - 1.5, (ICON_CHIP_PX - 1.5) / 2);
  ...
  if (tone === 'reported') {
    ctx.setLineDash([2, 2]);
    roundedRectPath(ctx, 3.25, 3.25, ICON_CHIP_PX - 6.5, ICON_CHIP_PX - 6.5, (ICON_CHIP_PX - 6.5) / 2);
  ...
  // evenodd, а не nonzero. Гліфи малюють отвори — колесо й ступицю гаубиці, труби РСЗВ, кільце знака
  // питання — окремими підконтурами поверх заливки, і лише evenodd робить із них отвори; nonzero
  // зафарбував би колесо суцільним диском. Той самий fill-rule стоїть у SVG легенди.
...
const promptVersionNames = {
  ...
  'vector-narrative-v1': 'Формулювання екстраполяції вектора',
  ...
  'actualization-v1': 'Актуалізація треку'
};
...
const aiRunSurfaceNames = {
  ...
  // Не «Аналіз атак»: цей перемикач ніколи не стосувався публічної сторінки атак — він гейтить
  // формулювання операторської екстраполяції вектора й більше нічого. Публічний тактичний блок
  // має власний перемикач «Тактика».
  attacks: 'Формулювання екстраполяції вектора',
  ...
  // Швидка модель перечитує свіжі повідомлення події й каже, де ціль зараз. Лише форма треку на карті:
  // подій, тривог і відбоїв ця поверхня не торкається.
  actualization: 'Актуалізація треку'
};
...
// ------------------------------------------------------------------------------------------------
//
// Перемикач на кожну поверхню, а не один. «Увімкнути ШІ» — це не рішення, яке оператор може
// ухвалити один раз: наратив аналітики бачить лише він сам, дайджест іде тисячам людей у Telegram,
// коментар до тактики лягає на публічну сторінку, а формулювання екстраполяції й дослідження області
// не залишають цієї консолі взагалі. Ціна помилки в кожному з цих місць різна, тож і вимикач у
...
const codexFeatureLabels = {
  ...
  // Назва цього перемикача пережила своє значення й уводила в оману: «Аналіз атак» читається як
  // публічна сторінка атак, хоча прапорець гейтить рівно один виклик — формулювання операторської
  // екстраполяції вектора в /ops. Колонку в базі не перейменовували (це коштувало б збереженого
  // вибору оператора), тому виправлено підпис.
  attacks: {
    title: 'Формулювання екстраполяції вектора',
    note: 'Модель переказує людською мовою операторську екстраполяцію вектора. Не публікується ніде за межами цієї консолі, до публічної сторінки атак стосунку не має. Числа так само звіряються з розрахунком.'
  },
  ...
  // Шостий перемикач — перший, чий текст потрапляє одразу на публічну сторінку, а не в консоль і не
  // в Telegram. Самі спостереження рахує SQL і показує їх незалежно від цього прапорця; модель лише
  // переказує їх словами, і текст відкидається цілком, якщо в ньому зʼявиться число, клас загрози
  // чи область поза переліком спостережень — або будь-яке прогнозування.
  tactics: {
    title: 'Тактика: коментар',
    note: 'Короткий переказ того, що змінилося за добу, під блоком тактики на публічній сторінці атак. Самі зміни рахує SQL і показує в будь-якому разі. Текст підписано як написаний моделлю; жодних прогнозів ударів він містити не може — перевірка відхиляє їх дослівно.'
  },
  // Сьомий — протилежний край: операторська записка, яку ніхто, крім цієї консолі, не бачить, і яку
  // не можна цитувати публічно. Планувальник її не запускає ніколи: тільки натиснута кнопка.
  attack_research: {
  ...
  // Результат цього перемикача бачить кожен читач карти, а право в нього найвужче: модель лише
  // впорядковує місця, які вже назвали повідомлення події. Підпис мусить сказати обидві межі — що
  // це лише форма треку і що без режиму Codex перемикач нічого не робить.
  actualization: {
    title: 'Актуалізація треку (швидка модель)',
    note: 'У режимі Codex швидка модель перечитує свіжі повідомлення активної події й каже, де ціль зараз: рухається, кружляє, минула чи завершилась, і які місця вже історія. Це лише форма треку на карті з місць, які назвали самі повідомлення: подій, тривог і відбоїв модель не створює й не завершує. Діє лише впевнена відповідь, що бачила найсвіжіше повідомлення; інакше й за будь-якого збою — трек за правилами. У режимі «правила» не діє.'
  }
};
...
function opsCodexSettingsSection(payload) {
  ...
  // Швидка модель — окремий вибір, бо поверхні різні за ціною запізнення. Класифікатор, тінь,
  // ретроспективний гейт, переказ руху й актуалізація треку стоять на гарячому шляху кожного
  // повідомлення: відповідь, що прийшла після того, як загроза минула, не варта нічого. Наратив,
  // дайджест, статистика й дослідження можуть чекати основну. «Як основна» — теж вибір, а не
  // порожнеча: тоді обидві групи йдуть однією моделлю, як до появи цього поля. Каталог той самий.
  const fastOptions = [
    `<option value=""${settings.fastModel ? '' : ' selected'}>як основна</option>`,
    ...models.map((model) => `<option value="${escapeHtml(model)}"${settings.fastModel === model ? ' selected' : ''}>${escapeHtml(model)}</option>`)
  ].join('');
  const effectiveFast = settings.effectiveFastModel
    ? `Гарячий шлях викликає <code>${escapeHtml(settings.effectiveFastModel)}</code>${settings.fastModel ? '' : ' — ту саму, що й основна'}.`
    : 'Для гарячого шляху моделі немає — класифікують правила.';
  // flex у черзі немає: обліковий запис ChatGPT Codex відповідав на нього 400 «Unsupported
  // service_tier: flex» на КОЖЕН виклик, і з 20.08 кожне повідомлення мовчки йшло правилам.
  const tiers = [['priority', 'priority — швидка'], ['default', 'default — звичайна']];
  ...
  return `<section class="ops-section" id="codex-settings-section">
    ...
    <div class="codex-settings">
      ...
      <label class="codex-model">Швидка модель — класифікатор і актуалізація<select data-codex-fast-model>${fastOptions}</select></label>
      <p class="legend-note">Класифікатор, тіньова класифікація, ретроспективний гейт, переказ руху й актуалізація треку. ${effectiveFast}</p>
      ...
      <label class="codex-model">Черга обслуговування<select data-codex-tier>${
        tiers.map(([value, label]) => `<option value="${value}"${
      ...
      <p class="legend-note">Вимкнене — це не помилка й не деградація: аналітика, дайджест, екстраполяція, тактика й дослідження повні без моделі. Перемикач лише додає текст поверх готових чисел.</p>
    </div>
  </section>`;
}
  ...
  $('[data-codex-settings-save]', root)?.addEventListener('click', async () => {
    ...
    const result = await opsFetch('/ops/codex/settings', {
      ...
      body: JSON.stringify({
        ...
        // Порожній вибір — «як основна», тобто null, а не порожній рядок: сервер рахує швидку модель
        // як fastModel ?? основна, і рядок '' у цьому ланцюжку не мав би значення.
        fastModel: $('[data-codex-fast-model]', root)?.value || null,
...
const APP_SETTING_LABELS = {
  ...
  ACTUALIZATION_MAX_PER_MINUTE: 'Бюджет актуалізації треку',
  ACTUALIZATION_TIMEOUT_MS: 'Тайм-аут актуалізації треку',
...
function renderCurrentRoute(options = {}) {
  ...
  if (map && route !== '/') {
    stopThreatWave(); stopOriginWave(); stopVectorDraw(); stopVectorTravel();
